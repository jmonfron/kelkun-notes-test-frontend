...
export function TaskStatusTab({ activeFilter, setActiveFilter   }: IProps) {
  return (
    <div className="flex items-center gap-2 border-b border-gray-800 py-4 justify-between md:justify-start">
